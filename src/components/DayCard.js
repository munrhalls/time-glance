...
function DayCard({dayCard, hourWidth}) {
  ...
  const tailwindCSS = `${width} h-${hourUnit * 10} ${left} ${bgColor} h-full absolute text-black text-2xl bg-black border-black  border-2 rounded-2x1 flex justify-center content-center`
